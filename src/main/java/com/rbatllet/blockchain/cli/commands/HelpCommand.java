 ...
 */
@Command(name = "help", description = "Show detailed help for commands")
public class HelpCommand implements Runnable {
    ...
    public void run() {
        try {
            ...
            System.out.println(
                "  Command line interface for managing a private blockchain."
            );
            System.out.println(
                "  Provides secure, authorized-only blockchain operations."
            );
            System.out.println();

            System.out.println("USAGE:");
            System.out.println(
                "  blockchain [GLOBAL_OPTIONS] COMMAND [COMMAND_OPTIONS]"
            );
            System.out.println();
            ...
            System.out.println(
                "     Options: -j/--json, -d/--detailed, -q/--quick"
            );
            System.out.println();

            System.out.println(
                "  📦 add-block       Add a new block to the blockchain"
            );
            System.out.println("     Usage: add-block \"data\" [options]");
            System.out.println(
                "     Options: -s/--signer, --key-file, -g/--generate-key, -j/--json"
            );
            System.out.println();
            ...
            System.out.println(
                "     Options: -k/--public-key, -g/--generate, -j/--json, --show-private"
            );
            System.out.println();

            System.out.println("  📋 list-keys       List authorized keys");
            System.out.println(
                "     Options: -j/--json, -a/--active-only, -d/--detailed"
            );
            System.out.println();

            System.out.println(
                "  📤 export          Export blockchain to file"
            );
            System.out.println("     Usage: export \"filename\" [options]");
            System.out.println(
                "     Options: -f/--format, --overwrite, -j/--json, -c/--compress"
            );
            System.out.println();

            System.out.println(
                "  📥 import          Import blockchain from file"
            );
            System.out.println("     Usage: import \"filename\" [options]");
            System.out.println(
                "     Options: --backup, --force, -j/--json, --validate-after, --dry-run"
            );
            System.out.println();

            System.out.println(
                "  🔍 search          Search blocks by content, hash, or date"
            );
            System.out.println("     Usage: search [term] [options]");
            System.out.println(
                "     Options: -c/--content, -h/--hash, -n/--block-number,"
            );
            System.out.println(
                "              --date-from, --date-to, --datetime-from, --datetime-to,"
            );
            System.out.println(
                "              -j/--json, -l/--limit, --detailed"
            );
            System.out.println();
            ...
            System.out.println(
                "  blockchain add-key \"Bob\" --public-key \"MIIBIjANBgkq...\""
            );
            System.out.println();

            System.out.println("  # Block operations");
            System.out.println(
                "  blockchain add-block \"Transaction: Alice pays Bob 100 coins\" --generate-key"
            );
            System.out.println(
                "  blockchain add-block \"System update\" --signer Alice"
            );
            System.out.println();
            ...
            System.out.println(
                "  blockchain search --date-from 2025-01-01 --date-to 2025-01-31"
            );
            System.out.println(
                "  blockchain search --hash \"a1b2c3d4e5f6...\""
            );
            System.out.println();
            ...
            System.out.println(
                "  blockchain import blockchain_backup.json --backup"
            );
            ...
            System.out.println(
                "For command-specific help: blockchain COMMAND --help"
            );
        } catch (SecurityException e) {
            BlockchainCLI.error(
                "Help command failed: Security error - " + e.getMessage()
            );
            ExitUtil.exit(1);
        } catch (RuntimeException e) {
            BlockchainCLI.error(
                "Help command failed: Runtime error - " + e.getMessage()
            );
            ExitUtil.exit(1);
        } catch (Exception e) {
            BlockchainCLI.error(
                "Help command failed: Unexpected error - " + e.getMessage()
            );
            ExitUtil.exit(1);
        }
    }
